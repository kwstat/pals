...
The purpose of the `pals` package is twofold: (1) provide a comprehensive collection of color palettes and colormaps (2) provide tools for evaluating these collections.  Memory use is reduced by compressing colormaps to fewer colors and by calling colorRampPalette only when a colormap is requested.
